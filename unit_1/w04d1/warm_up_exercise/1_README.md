...
2. Write user stories from the perspective of the user: "As a user, I need something so that why" or "As a user, I want to be able to perform/do something so that I get some form of value or benefit".
