    ...
    return (
      <div>
        ...
        <div>
          <form onSubmit={this.handleSubmit}>
            <label htmlFor="name">Name</label>
            <input class="mx-2" type="text" value={this.state.name} onChange={this.handleChange} id="name" placeholder='name of product' />
            <label htmlFor="price">Price</label>
            <input class="mx-2" type="number" value={this.state.price} onChange={this.handleChange} id="price" />
            <label htmlFor="description">Description</label>
            <input class="mx-2" type="textarea" value={this.state.description} onChange={this.handleChange} id="description" />
            <input class="mx-2" type="submit" />
          </form>
        </div>
        <div>
          <ul class='list-group'>
