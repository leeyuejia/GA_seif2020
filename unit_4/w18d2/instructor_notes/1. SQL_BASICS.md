...
If using the OSX app that https://www.postgresql.org/ provides, you can list databases from the terminal:

```sql
psql -l -- list all databases
psql db_name -- start psql app, using the database db_name
```

Once inside the `psql` app, you can list the databases like this:
...
Postgres can have many databases:

```SQL
CREATE DATABASE foo; -- create database foo
DROP DATABASE foo; -- drop it
CREATE DATABASE test_db;
\connect test_db; -- connect to the test_db database
```
...
<<<<<<< HEAD
[Complete data types](https://www.postgresqltutorial.com/postgresql-data-types/◊)
[New Complete data types](https://www.postgresqltutorial.com/postgresql-data-types/)
=======
[Complete data types](https://www.postgresqltutorial.com/postgresql-data-types/)
>>>>>>> 2b8fdcbf38ece016d51a6e7cb9889fd9d6d248bb
